...
@ CS309-01 :    2020
@ Purpose  :    ARM Hello World (ARM1) Assignment
@
...
@   r7 - Must contain a 4 to write. 
    ...
    MOV   r2, #0x28    @ Length of string to print (in Hex).
...
@
    ...
    @LDR  r0, =string3  @ Put address of string in r0
    @BL   printf        @ Make the call to printf

@ Part 3 - Use system call to print string
...
string1: .asciz "My full name is: Joseph Daniel Schwalb.\n"  @Length 0x27

.balign 4   @ Force a word boundry
string2: .asciz "My UAH email address is: jds0099@uah.edu.\n" @Length 0x29

.balign 4   @ Force a word boundry
string3: .asciz "This is my first ARM Assembly program for CS309-01 2020.\n" @Length 0x38
